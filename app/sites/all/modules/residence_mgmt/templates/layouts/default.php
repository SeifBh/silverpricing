...
<!-- Required meta tags -->
    ...
    <!-- vendor css -->
    <link href="<?php echo MODULE_PATH; ?>/lib/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet">
    <link href="<?php echo MODULE_PATH; ?>/lib/ionicons/css/ionicons.min.css" rel="stylesheet">
    <link href="<?php echo MODULE_PATH; ?>/lib/jqvmap/jqvmap.min.css" rel="stylesheet">
    <link href="<?php echo MODULE_PATH; ?>/lib/typicons.font/typicons.css" rel="stylesheet">
    <link href="<?php echo MODULE_PATH; ?>/lib/prismjs/themes/prism-vs.css" rel="stylesheet">
    <link href="<?php echo MODULE_PATH; ?>/lib/datatables.net-dt/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="<?php echo MODULE_PATH; ?>/lib/datatables.net-responsive-dt/css/responsive.dataTables.min.css" rel="stylesheet">
    <link href="<?php echo MODULE_PATH; ?>/lib/select2/css/select2.min.css" rel="stylesheet">
    <link href="<?php echo MODULE_PATH; ?>/lib/ion-rangeslider/css/ion.rangeSlider.min.css" rel="stylesheet">
    <link href="https://js.api.here.com/v3/3.1/mapsjs-ui.css" rel="stylesheet" />

    <!-- DashForge CSS -->
    <link rel="stylesheet" href="<?php echo MODULE_PATH; ?>/assets/css/dashforge.css">
    <link rel="stylesheet" href="<?php echo MODULE_PATH; ?>/assets/css/dashforge.dashboard.css">
    <link rel="stylesheet" href="<?php echo MODULE_PATH; ?>/assets/css/dashforge.profile.css">
    <link rel="stylesheet" href="<?php echo MODULE_PATH; ?>/assets/css/skin.light.css">

    <!-- LEAFLET MAP -->
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.6.0/dist/leaflet.css" integrity="sha512-xwE/Az9zrjBIphAcBb3F6JVqxf46+CDLwfLMHloNu6KEQCAWi6HcDUbeOfBIptF7tcCzusKFjFw2yuvEpDL9wQ==" crossorigin=""/>

    <!-- Yealder CSS -->
    <link rel="stylesheet" href="<?php echo MODULE_PATH; ?>/assets/css/main.css" />
    <link rel="stylesheet" href="/z/global.css?a=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'z/global.css')?>" />
    <script src="/z/global.js?a=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'z/global.js')?>" ></script>

  </head>
  <body id="b">
  <div id="dashCap"></div>
    <aside class="aside aside-fixed minimize">
        <?php include_once __DIR__ . "/../partial/aside.inc.php"; ?>
    </aside>

    <div class="content ht-100v pd-0" id="c">
    ...
    <script src="<?php echo MODULE_PATH; ?>/lib/jquery/jquery.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/jqvmap/jquery.vmap.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/jqvmap/maps/jquery.vmap.france.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/feather-icons/feather.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/perfect-scrollbar/perfect-scrollbar.min.js"></script>

    <script src="<?php echo MODULE_PATH; ?>/lib/prismjs/prism.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/datatables.net-dt/js/dataTables.dataTables.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/datatables.net-responsive-dt/js/responsive.dataTables.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/assets/js/sorting_natural.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/lib/select2/js/select2.min.js"></script>

    <script src="<?php echo MODULE_PATH; ?>/assets/js/dashforge.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/assets/js/dashforge.aside.js"></script>

    <!-- Silverex JS SCRIPTS -->
    <!-- CHART JS -->
    <script src="<?php echo MODULE_PATH; ?>/lib/chart.js/Chart.bundle.min.js"></script>
    ...
    <!-- HERE MAP LIBRARY -->
    <script src="<?php echo MODULE_PATH; ?>/assets/js/here_library.js"></script>
    <!-- LEAFLET MAP -->
    <script src="https://unpkg.com/leaflet@1.6.0/dist/leaflet.js"></script>
    <!-- SLIDER RANGE -->
    <script src="<?php echo MODULE_PATH; ?>/lib/ion-rangeslider/js/ion.rangeSlider.min.js"></script>

    <!-- GAUGE CHART  -->
    <?php if( $currentMenu == "residences" ): ?>
    <script src="<?php echo MODULE_PATH; ?>/assets/js/raphael-2.1.4.min.js"></script>
    <script src="<?php echo MODULE_PATH; ?>/assets/js/justgage.js"></script>
    <?php endif; ?>

    <!-- SERVICES JS -->
    <script src="<?php echo MODULE_PATH; ?>/assets/js/services.js"></script>
    <!-- MAIN JS -->
    <script src="<?php echo MODULE_PATH; ?>/assets/js/main.js"></script>


    <script type="text/javascript">

      // Create an icon:
      var BASE_ICON_PATH = "<?php echo MODULE_PATH; ?>/assets/img/";
      var icon = {
      ...
      <?php if( $currentMenu == "dashboard" ): ?>
          ...
          $('#dashboard-quick-win-table').DataTable( {
              "language": {
                  url: "<?php echo MODULE_PATH; ?>/lib/datatables.net/i18n/French.json"
              },
              "searching": false,
              "lengthChange": false,
              "paging": false,
      ...
      <?php elseif( $currentMenu == "residence" ): ?>
        ...
        function updateMaquetteDOM( maquette, $maquetteRoot ) {
            ...
            if( $maquetteRoot.hasClass('maquette-modifiee') ) {
                additionOperation = '<a href="#" class="d-block operation-maquette add-item-maquette pd-0 mg-0" style="height: 8px"><img src="<?php echo MODULE_PATH; ?>/assets/img/caret-arrow-up.svg" width="10" height="10"/></a>';
                subtractOperation = '<a href="#" class="d-block operation-maquette subtract-item-maquette pd-0 mg-0" ><img src="<?php echo MODULE_PATH; ?>/assets/img/caret-arrow-down.svg" width="10" height="10"/></a>';
